...
/*  ************************* PRODUCTOS *************************** */
if (process.env.NODE_ENV !== 'production') {
    hamburguesa1 = new Producto('HB1', 'Hamburguesa Clasic', 'Hamburguesa clásico con JyQ', '349.99', '100');
    hamburguesa2 = new Producto('HB2', 'Hamburguesa Verde', 'Hamburguesa en base a vegetales', '399.99', '250');
    hamburguesa3 = new Producto('HB3', 'Hamburguesa Power', 'Hamburguesa con JyQ, tomate y cebolla', '449.99', '602');

    ensaladaCesar = new Producto('EC', 'Ensalada César', 'Ensalada César', '566,99', '20');
